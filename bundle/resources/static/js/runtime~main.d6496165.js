!(function(e) {
  function r(r) {
    for (var n, i, f = r[0], l = r[1], a = r[2], c = 0, s = []; c < f.length; c++)
      (i = f[c]), Object.prototype.hasOwnProperty.call(o, i) && o[i] && s.push(o[i][0]), (o[i] = 0);
  ...
  (i.m = e),
    ...
    (i.p = '/');
  var f = (window['webpackJsonpnazione-form-widget'] = window['webpackJsonpnazione-form-widget'] || []),
    l = f.push.bind(f);
  (f.push = r), (f = f.slice());
...
//# sourceMappingURL=runtime~main.d6496165.js.map
