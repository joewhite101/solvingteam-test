  ...
  [0],
  {
    164: function(e) {
      e.exports = JSON.parse(
        '{"error":{"dataLoading":"Error during server connection"},"common":{"save":"Save","dataSaved":"Data successfully saved","notAuthenticated":"User is not authenticated.","selectFile":"Upload new file","selectImageFile":"Upload new image","download":"Download"},"validation":{"required":"{{field}} is required"},"entities":{"city":{"id":"ID","name":"entities.city.name","descrizione":"entities.city.descrizione"}}}'
      );
    },
    187: function(e, t, n) {
      e.exports = n(335);
    ...
    335: function(e, t, n) {
      ...
      var x = Object.keys(P).reduce(function(e, t) {
          return (function(e) {
            ...
            return e;
          })({}, e, Object(u.a)({}, t, Object(u.a)({}, 'translation', P[t])));
        }, {}),
        z = w.a.t,
        N = function(e) {
          !(function(e, t) {
            ...
            (function(e) {
              var t = {
                mixed: {
                  required: function(t) {
                    var n = t.path;
                    return e('validation.required', { field: e('entities.city.'.concat(n)) });
                  }
                }
              };
              j.setLocale(t);
        ...
        F = { tableAdd: 'city.table.add', tableSelect: 'city.table.select' },
        U = {
          create: 'city.form.create',
          update: 'city.form.update',
          errorCreate: 'city.form.errorCreate',
          errorUpdate: 'city.form.errorUpdate'
        },
        T = n(15),
        A = n.n(T),
        M = n(30),
                    ...
                    d.a.createElement(
                      ...
                      d.a.createElement(
                        ...
                        d.a.createElement(ye.a, {
                          ...
                          value: n.descrizione,
                          name: 'descrizione',
                          label: u('entities.city.descrizione')
                        })
                      ),
                      d.a.createElement(
                        me.a,
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 6:
                                (o = e.sent),
                                  r(o),
                                  this.setState({ city: o, notificationMessage: a('common.dataSaved'), notificationStatus: pe.SUCCESS }),
                                  (e.next = 14);
                                break;
                              case 11:
              ...
              },
              {
                ...
                value: function() {
                  ...
                  return d.a.createElement(
                    ...
                    d.a.createElement(I, { keycloak: t }, d.a.createElement(Ee, { city: o, onSubmit: this.handleSubmit })),
      ...
      var ze = function() {
          return (
            (window && window.entando && window.entando.keycloak && xe({}, window.entando.keycloak, { initialized: !0 })) || {
              initialized: !1
            }
          );
        },
        ...
        De = (function(e) {
          function t() {
            ...
            return (
              ((n = Object(i.a)(this, (e = Object(o.a)(t)).call.apply(e, [this].concat(c)))).keycloak = ze()),
                ...
                },
                {
                  ...
                  value: function() {
                    ...
                    a.appendChild(this.mountPoint),
                      (this.jss = Object(k.b)(xe({}, Object(m.a)(), { insertionPoint: this.mountPoint }))),
                      (this.muiTheme = Object(O.a)({
                        props: { MuiDialog: { container: this.mountPoint }, MuiPopover: { container: this.mountPoint } }
                      })),
                      (this.keycloak = xe({}, ze(), { initialized: !0 })),
                      (this.unsubscribeFromKeycloakEvent =
                        ((t = 'keycloak'),
                        (n = function() {
                          (e.keycloak = xe({}, ze(), { initialized: !0 })), e.render();
                        }),
                    ...
                    if ('true' === this.getAttribute(Ne.hidden)) p.a.render(d.a.createElement(d.a.Fragment, null));
                      ...
                      var r = this.getAttribute(Ne.id),
                        i = r
                          ...
                          : d.a.createElement(Pe, { onCreate: this.onCreate, onError: this.onErrorCreate }, null);
                      p.a.render(
                        d.a.createElement(
                          g.Provider,
                          { value: this.keycloak },
                          d.a.createElement(v.b, { jss: this.jss }, d.a.createElement(y.a, { theme: this.muiTheme }, i))
                        ),
                        this.mountPoint
                      );
                    }
      ...
      customElements.define('city-form', De);
    }
  },
  [[187, 1, 2]]
]);
//# sourceMappingURL=main.7d2ff483.chunk.js.map
