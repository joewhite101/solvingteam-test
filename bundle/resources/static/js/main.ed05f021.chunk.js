        ...
        I = function(e) {
          ...
          return h.a.createElement(
            ...
            h.a.createElement(
              R.a,
              null,
              h.a.createElement(A.a, null, h.a.createElement(z.a, null, t('common.name')), h.a.createElement(z.a, null, t('common.value')))
            ),
            h.a.createElement(
              C.a,
              null,
              h.a.createElement(
                A.a,
                null,
                h.a.createElement(z.a, null, h.a.createElement('span', null, t(''.concat('entities.city.', 'id')))),
                h.a.createElement(z.a, null, h.a.createElement('span', null, n.id))
              ),
              h.a.createElement(
                A.a,
                null,
                h.a.createElement(z.a, null, h.a.createElement('span', null, t(''.concat('entities.city.', 'name')))),
                h.a.createElement(z.a, null, h.a.createElement('span', null, n.name))
              ),
              h.a.createElement(
                A.a,
                null,
                h.a.createElement(z.a, null, h.a.createElement('span', null, t(''.concat('entities.city.', 'descrizione')))),
      ...
      var M = Object(o.b)()(I),
        F = function(e) {
          ...
          return h.a.createElement(
            S.a,
            null,
            h.a.createElement('h3', null, t('common.widgetName', { widgetNamePlaceholder: 'City' })),
                      ...
                      ? (function() {
                          var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                            ...
                            i = ''
                              ...
                              .concat(t),
                            o = { headers: new Headers({ Authorization: 'Bearer '.concat(a), 'Content-Type': 'application/json' }) };
                          ...
                          .then(function(t) {
                            return e.setState({ notificationStatus: null, notificationMessage: null, city: t });
                          })
                          .catch(function(t) {
                            a(t), e.setState({ notificationStatus: ee.ERROR, notificationMessage: i('common.couldNotFetchData') });
                          })
                          .finally(function() {
                            return e.setState({ loading: !1 });
                          })
                      : this.setState({ loading: !1, notificationStatus: ee.ERROR, notificationMessage: i('common.missingId') }));
                }
              },
              {
              ...
              },
              {
                ...
                value: function() {
                  ...
                  return h.a.createElement(
                    ...
                    h.a.createElement(P, { keycloak: r }, i && c('common.loading'), !i && h.a.createElement(L, { city: t })),
                    h.a.createElement(ee, { status: n, message: a, onClose: this.closeNotification })
                  );
                }
              }
            ]),
      ...
      var ue = function() {
        ...
        de = (function(e) {
          function t() {
            ...
            return (
              ((n = Object(d.a)(this, (e = Object(m.a)(t)).call.apply(e, [this].concat(i)))).mountPoint = null),
                ...
                value: function() {
                  var e = this,
                    ...
                    n = h.a.createElement(re, {
                      id: t,
                      onError: function(t) {
                        var n = new CustomEvent(''.concat('city.details.', 'error'), { details: { error: t } });
                        e.dispatchEvent(n);
                      }
                    });
                  O.a.render(h.a.createElement(k.Provider, { value: this.keycloak }, n), this.mountPoint);
                }
              },
              {
