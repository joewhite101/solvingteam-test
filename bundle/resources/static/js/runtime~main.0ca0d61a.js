!(function(e) {
  function t(t) {
    for (var n, i, l = t[0], a = t[1], f = t[2], p = 0, s = []; p < l.length; p++)
  ...
  (i.m = e),
    ...
    (i.p = '/');
  var l = (window['webpackJsonpcity-details-widget'] = window['webpackJsonpcity-details-widget'] || []),
    a = l.push.bind(l);
  (l.push = t), (l = l.slice());
...
//# sourceMappingURL=runtime~main.0ca0d61a.js.map
