!(function(e) {
  function r(r) {
    for (var n, l, a = r[0], i = r[1], p = r[2], c = 0, s = []; c < a.length; c++)
  ...
  (l.m = e),
    ...
    (l.p = '/');
  var a = (window['webpackJsonppersona-table-widget'] = window['webpackJsonppersona-table-widget'] || []),
    i = a.push.bind(a);
  (a.push = r), (a = a.slice());
...
//# sourceMappingURL=runtime~main.60723e2a.js.map
