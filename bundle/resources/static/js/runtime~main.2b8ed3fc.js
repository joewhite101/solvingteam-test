!(function(e) {
  function r(r) {
    for (var n, f, i = r[0], l = r[1], a = r[2], c = 0, s = []; c < i.length; c++)
      (f = i[c]), Object.prototype.hasOwnProperty.call(o, f) && o[f] && s.push(o[f][0]), (o[f] = 0);
  ...
  (f.m = e),
    ...
    (f.p = '/');
  var i = (window['webpackJsonppersona-form-widget'] = window['webpackJsonppersona-form-widget'] || []),
    l = i.push.bind(i);
  (i.push = r), (i = i.slice());
...
//# sourceMappingURL=runtime~main.2b8ed3fc.js.map
