...
class NazioneDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'nazione.details.';
    ...
    const ReactComponent = React.createElement(NazioneDetailsContainer, {
      id,
      onError,
    });
    ReactDOM.render(
...
customElements.define('nazione-details', NazioneDetailsElement);
