...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/city/formWidget/>):
    1. Run `npm i`
...
-   **city.form.createError** (fired when an error occurs during city creation)
-   **city.form.create** (fired when the city is successfully created)
-   **city.form.updateError** (fired when an error occurs during city update)
-   **city.form.update** (fired when the city is successfully updated)
