...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/city/tableWidget/>):
    1. Run `npm i`
...
-   **city.table.error** (fired when an error occurs)
-   **city.table.select** (fired when a table row is selected)
