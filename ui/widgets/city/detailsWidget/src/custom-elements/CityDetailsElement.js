...
class CityDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'city.details.';
    ...
    const ReactComponent = React.createElement(CityDetailsContainer, {
      id,
      onError,
    });
    ReactDOM.render(
...
customElements.define('city-details', CityDetailsElement);
