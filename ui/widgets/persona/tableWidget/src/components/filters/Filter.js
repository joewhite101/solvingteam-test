    ...
    <Grid container>
      <Grid item xs={5}>
        <FormControl className={classes.formControl}>
          ...
          >
            <option value="" />
            <option value="nome">{t('entities.persona.nome')}</option>
            <option value="cognome">{t('entities.persona.cognome')}</option>
            <option value="codiceFiscale">{t('entities.persona.codiceFiscale')}</option>
            <option value="indirizzo">{t('entities.persona.indirizzo')}</option>
            <option value="numeroConsolato">{t('entities.persona.numeroConsolato')}</option>
          </Select>
        </FormControl>
      </Grid>
      <Grid item xs={3}>
