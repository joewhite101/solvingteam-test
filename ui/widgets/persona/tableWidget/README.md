...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/persona/tableWidget/>):
    1. Run `npm i`
...
-   **persona.table.error** (fired when an error occurs)
-   **persona.table.select** (fired when a table row is selected)
