...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/persona/formWidget/>):
    1. Run `npm i`
...
-   **persona.form.createError** (fired when an error occurs during persona creation)
-   **persona.form.create** (fired when the persona is successfully created)
-   **persona.form.updateError** (fired when an error occurs during persona update)
-   **persona.form.update** (fired when the persona is successfully updated)
